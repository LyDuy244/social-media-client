...
const Page = () => {
  ...
  return (
    <div className={"absolute  inset-0 z-20 bg-[#293139a6] flex justify-center"}>
      <div className={"py-4 px-8 rounded-xl bg-black w-[600px] h-max mt-12"}>
        {/*TOP*/}
        <div className={"flex items-center justify-between"}>
          <div className={"cursor-pointer"} onClick={closeModal}>X</div>
          <div className={"text-iconBlue"}>Drafts</div>
        </div>
        {/*CENTER*/}
        <div className={"py-8 flex gap-4"}>
          ...
          <input className={"flex-1 bg-transparent outline-none text-lg"} type="text"
